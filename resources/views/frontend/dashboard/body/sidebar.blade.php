...
<div class="logo-box px-4">
    <a href="{{ url('/dashboard') }}" class="logo"><img src="{{ asset('frontend/images/logo.png') }}" alt="logo"></a>
</div>
<ul class="generic-list-item off-canvas-menu-list off--canvas-menu-list pt-35px">
    <li class="page-active"><a href="{{ url('/dashboard') }}"><svg class="mr-2" xmlns="http://www.w3.org/2000/svg"
